    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('employees.store') }}" id="create-form" method="post" enctype="multipart/form-data">
                    @csrf
...
@push('js')
    ...
    <x-employee.employee-js route="data.products" />
@endpush
